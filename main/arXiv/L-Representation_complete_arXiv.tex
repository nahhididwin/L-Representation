...
\begin{lstlisting}[language=Python,caption={Algorithm: Bit-width and segmentation (pseudo-code)}]
...
The listing is intentionally self-contained. Copy–paste into a file named \texttt{lrep_complete_prototype.py} and run with Python+NumPy.

\begin{lstlisting}[language=Python,caption={lrep_complete_prototype.py — extended prototype (abridged but runnable)}]
#!/usr/bin/env python3
