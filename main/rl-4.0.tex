...
% ---- Title ----
\title{\textbf{L-Representation: A Formally Verified Framework for Constraint-Aware Fixed-Point Arithmetic in Structured Algebras\\, with Applications to Geometric Algebra Hardware}\\[6pt]
